...
func warp_exp_wide104{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
...
func warp_exp_wide112{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide120{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide128{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide136{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide144{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide152{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide160{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide168{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide176{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide184{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide192{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide200{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide208{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide216{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide224{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide232{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide240{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
...
func warp_exp_wide248{range_check_ptr, bitwise_ptr : BitwiseBuiltin*}(
    lhs : felt, rhs : Uint256
) -> (res : felt):
    if rhs.low == 0:
        if rhs.high == 0:
